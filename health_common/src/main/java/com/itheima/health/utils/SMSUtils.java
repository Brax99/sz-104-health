...
public class SMSUtils {
	...
	private static final String ACCESS_KEY="LTAI4G2C5zET1MLj561tS1Ue"; //你的AccessKey ID
	private static final String SECRET_KEY="nrsfNBoXa110YBEfBBvn6DRynjBgjk"; //你的AccessKey Secret
