...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "u21X6cLtPmrw-B1fAWj7NDzAF44_c_Lw3OGqtikk";
    private static final String SECRETKEY = "HDK7gb2QcGvg-wgjD2CbpA31l7hXgXiLWMmBrXqS";
    private static final String BUCKET = "sz-104";
    public static final String DOMAIN= "http://qkafraho0.hn-bkt.clouddn.com/";
